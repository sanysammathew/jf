...
/**
 * Data Mapper implementation for Application_Model_Users
 *
 * @package Application_Model
 * @subpackage Mapper
 * @author Sany
 */
class Application_Model_UsersMapper extends Application_Model_Mapper_MapperAbstract
{
    /**
    ...
    {
        if (! $model instanceof Application_Model_Users) {
     ...
     *
     * @param Application_Model_Users $model The model to delete
     ...
     * @param Application_Model_Users|null $model
     * @return Application_Model_Users|null The object provided or null if not found
     */
     ...
     * @param Application_Model_Users|null $entry The object to load the data into, or null to have one created
     * @return Application_Model_Users The model with the data provided
     */
	...
	$result = $this->getDbTable()->fetchAll($this->getDbTable()->fetchData($data))->toArray();
	return $result;
    }
    public function getallData(){	 
	$result = $this->getDbTable()->fetchAll($this->getDbTable()->fetchallData())->toArray();
	return $result;
    }
    public function chkUserData($data){	 
	$result = $this->getDbTable()->fetchAll($this->getDbTable()->chkUserData($data))->toArray();
	return $result;
    }
    public function chkemptyuser($data){	 
	$result = $this->getDbTable()->fetchAll($this->getDbTable()->chkemptyuser($data))->toArray();
	return $result;
    }
}
